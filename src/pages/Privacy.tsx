const sections = [
  ...
  { id: "usage", title: "2. How We Use Your Information", content: "We use your information to provide and improve the Juriq service, process your documents for analysis, communicate with you about your account, and send service-related notifications. We do not use your uploaded documents to train our core AI models, and we strictly utilize enterprise-grade APIs (such as OpenAI or Google Gemini APIs) that explicitly guarantee your data is zero-retained and never used for model training purposes." },
