    ...
    return (
        <div className="min-h-screen bg-off-white dark:bg-midnight-bg text-slate-900 dark:text-text-bright font-display transition-colors duration-300">
            ...
            <Header
                ...
                darkMode={theme === 'dark'}
                toggleDarkMode={() => { }} // Pass dummy or fix context usage if needed, or better, make Header handle it
            />
            {/* Note: The Header inside Pricing used to be inline. I am replacing it with the global Header component for consistency.
                However, I need to make sure 'toggleDarkMode' is available. 
                Wait, 'PricingAndTerms' uses `useTheme` so it has `theme` but `toggleTheme` was not destructured.
                I need to update line 93 to get toggleTheme.
             */}
