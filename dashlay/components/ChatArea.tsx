        ...
        {messages.length === 0 && (
             <div className="h-full flex flex-col items-center justify-center text-center select-none pb-20">
                ...
                <div className="relative mb-8 group animate-slide-up">
                    ...
                    <div className="w-20 h-20 bg-gradient-to-b from-white to-slate-300 text-midnight-bg rounded-2xl flex items-center justify-center relative shadow-glow transform transition-transform duration-700 hover:scale-105 hover:rotate-3">
